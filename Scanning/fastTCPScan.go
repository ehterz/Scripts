...
var (
	...
	host = flag.String("host", "10.10.10.102","Host o Dirección Ip a escanear")
	ports = flag.String("range", "1-65535", "Rango de puertos a comprobar: 80, 443, 1-65535,1000-2-000 ...")
...
func main(){
	ctx, cancel := context.WithCancel(context.Background()) //Definir contexto
	defer cancel()
